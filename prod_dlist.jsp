...
<div id="prod_list"> <!-- 오른쪽 div 시작 -->
	<div align="center" id="orderby"> <!-- 상품 order by 시작 -->
		order by
	</div> <!-- 상품 order by 끝 -->
	<div id="list" style="width:1200px;"> <!-- 상품 목록 시작 -->
		<ul> <!-- while문 한줄에 4개 총 5줄 -->
			...
			<li>
				<div id="prod_img"><a href="prod_content.jsp?prod_id=${pdto.prod_id }"><img src="상품사진/${pdto.prod_id }_i1_290.jpg" id="img"></a></div>
				<div id="info">
					<div> 이마트몰</div>
					<div> #No Brand</div>
					<div style="width:200px;height:60px;overflow:hidden;font-size:14px;"> <a href="prod_content.jsp?prod_id=${pdto.prod_id }">${pdto.prod_name }</a> </div>
