...
<style>
	...
	#category
	{
		padding-top:20px;padding-bottom:20px;padding-left:240px;
		margin:20px;
	...
	#category_left
	{
		display:table-cell;width:190px;top:0;
...
%>
<!-- 문서 시작 -->
<div id="third_prod_list" align="center" style="width:1800px"> <!-- 전체 문서의 시작 -->
...
<div id="prod_list" style="margin-top:-30px;"> <!-- 오른쪽 div 시작 -->
